...
//    qrc.style.width = wd + "px"
//    qrc.style.height = ht + "px"
    qrc.canvas.width = wd;
...
function doqr(input) {
    ...
    ecclevel = 4
     //console.log(d.qrinp.qrinput.value);
     //console.log(d.getElementById('qrcode').innerHTML);
   // qf = genframe(d.qrinp.qrinput.value);
    //qf = genframe(d.getElementById('qrcode').innerHTML);
    qf=genframe(input);
    qrc.lineWidth=1;
